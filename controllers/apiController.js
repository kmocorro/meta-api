            ...
            function cycletime_today(){
                return new Promise((resolve, reject) => {
                    mysql.getConnection((err, connection) => {
                        ...
                        connection.query({
                            sql: 'SET @@session.time_zone = "+08:00"; SELECT * FROM meta_dashboard_cycletime WHERE upload_date = CURDATE();'
                        },  (err, results) => {
                            if(err){return reject(err)};
            ...
            function cycletime_yesterday(){
                return new Promise((resolve, reject) => {
                    mysql.getConnection((err, connection) => {
                        ...
                        connection.query({
                            sql: 'SET @@session.time_zone = "+08:00"; SELECT * FROM meta_dashboard_cycletime WHERE upload_date = CURDATE() - INTERVAL 1 DAY;'
                        },  (err, results) => {
                            if(err){return reject(err)};
