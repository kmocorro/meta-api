                    ...
                    for(let i=1; i<ACL72_Pre_Worksheet.length;i++){
                        if(ACL72_Pre_Worksheet[i].A){
                            ACL72_Pre_clean.push(
                                [
                                    excelFile.date_upload,
                                    ACL72_Pre_Worksheet[i].A,
                                    ACL72_Pre_Worksheet[i].B,
                                    ACL72_Pre_Worksheet[i].C,
                                    ACL72_Pre_Worksheet[i].D,
                                    ACL72_Pre_Worksheet[i].E,
                                    ACL72_Pre_Worksheet[i].F,
                                    ACL72_Pre_Worksheet[i].G,
                                    ACL72_Pre_Worksheet[i].H,
                                    ACL72_Pre_Worksheet[i].I,
                                    ACL72_Pre_Worksheet[i].J,
                                    ACL72_Pre_Worksheet[i].K,
                                    ACL72_Pre_Worksheet[i].L,
                                    new Date((ACL72_Pre_Worksheet[i].M, - (25567 + 1))*86400*1000), // im doing this because excel serialized the date
                                    ACL72_Pre_Worksheet[i].N,
                                    ACL72_Pre_Worksheet[i].O,
                                    ACL72_Pre_Worksheet[i].P,
                                    ACL72_Pre_Worksheet[i].Q,
                                    ACL72_Pre_Worksheet[i].R,
                                    ACL72_Pre_Worksheet[i].S,
                                    ACL72_Pre_Worksheet[i].T,
                                    ACL72_Pre_Worksheet[i].U,
                                    ACL72_Pre_Worksheet[i].V,
                                    ACL72_Pre_Worksheet[i].W,
                                    ACL72_Pre_Worksheet[i].X,
                                    ACL72_Pre_Worksheet[i].Y,
                                    ACL72_Pre_Worksheet[i].Z,
                                    ACL72_Pre_Worksheet[i].AA,
                                    ACL72_Pre_Worksheet[i].AB,
                                    ACL72_Pre_Worksheet[i].AC,
                                    ACL72_Pre_Worksheet[i].AD,
                                    ACL72_Pre_Worksheet[i].AE,
                                    ACL72_Pre_Worksheet[i].AF,
                                    ACL72_Pre_Worksheet[i].AG,
                                    ACL72_Pre_Worksheet[i].AH,
                                    ACL72_Pre_Worksheet[i].AI,
                                    ACL72_Pre_Worksheet[i].AJ,
                                    ACL72_Pre_Worksheet[i].AK,
                                    ACL72_Pre_Worksheet[i].AL,
                                    ACL72_Pre_Worksheet[i].AM,
                                    ACL72_Pre_Worksheet[i].AN,
                                    ACL72_Pre_Worksheet[i].AO,
                                    ACL72_Pre_Worksheet[i].AP,
                                    ACL72_Pre_Worksheet[i].AQ,
                                    ACL72_Pre_Worksheet[i].AR,
                                    ACL72_Pre_Worksheet[i].AS,
                                    ACL72_Pre_Worksheet[i].AT,
                                    ACL72_Pre_Worksheet[i].AU,
                                    ACL72_Pre_Worksheet[i].AV,
                                    ACL72_Pre_Worksheet[i].AW,
                                    ACL72_Pre_Worksheet[i].AX,
                                    ACL72_Pre_Worksheet[i].AY,
                                    ACL72_Pre_Worksheet[i].AZ,
                                    ACL72_Pre_Worksheet[i].BA,
                                    ACL72_Pre_Worksheet[i].BB,
                                    ACL72_Pre_Worksheet[i].BC,
                                    ACL72_Pre_Worksheet[i].BD,
                                    ACL72_Pre_Worksheet[i].BE,
                                    ACL72_Pre_Worksheet[i].BF,
                                    ACL72_Pre_Worksheet[i].BG,
                                    ACL72_Pre_Worksheet[i].BH,
                                    ACL72_Pre_Worksheet[i].BI,
                                    ACL72_Pre_Worksheet[i].BJ,
                                    ACL72_Pre_Worksheet[i].BK,
                                    ACL72_Pre_Worksheet[i].BL,
                                    ACL72_Pre_Worksheet[i].BM,
                                    ACL72_Pre_Worksheet[i].BN,
                                    ACL72_Pre_Worksheet[i].BO,
                                    ACL72_Pre_Worksheet[i].BP,
                                    ACL72_Pre_Worksheet[i].BQ,
                                    ACL72_Pre_Worksheet[i].BR,
                                    ACL72_Pre_Worksheet[i].BS,
                                    ACL72_Pre_Worksheet[i].BT,
                                    ACL72_Pre_Worksheet[i].BU,
                                    ACL72_Pre_Worksheet[i].BV,
                                    ACL72_Pre_Worksheet[i].BW,
                                    ACL72_Pre_Worksheet[i].BX,
                                    ACL72_Pre_Worksheet[i].BY,
                                    ACL72_Pre_Worksheet[i].BZ,
                                    ACL72_Pre_Worksheet[i].CA,
                                    ACL72_Pre_Worksheet[i].CB,
                                    ACL72_Pre_Worksheet[i].CC,
                                    ACL72_Pre_Worksheet[i].CD,
                                    ACL72_Pre_Worksheet[i].CE,
                                    ACL72_Pre_Worksheet[i].CF,
                                    ACL72_Pre_Worksheet[i].CG,
                                    ACL72_Pre_Worksheet[i].CH,
                                    ACL72_Pre_Worksheet[i].CI,
                                    ACL72_Pre_Worksheet[i].CJ,
                                    ACL72_Pre_Worksheet[i].CK,
                                    ACL72_Pre_Worksheet[i].CL,
                                    ACL72_Pre_Worksheet[i].CM,
                                    ACL72_Pre_Worksheet[i].CN,
                                    ACL72_Pre_Worksheet[i].CO,
                                    ACL72_Pre_Worksheet[i].CP,
                                    ACL72_Pre_Worksheet[i].CQ,
                                    ACL72_Pre_Worksheet[i].CR,
                                    ACL72_Pre_Worksheet[i].CS,
                                    ACL72_Pre_Worksheet[i].CT,
                                    ACL72_Pre_Worksheet[i].CU,
                                    ACL72_Pre_Worksheet[i].CV,
                                    ACL72_Pre_Worksheet[i].CW,
                                    ACL72_Pre_Worksheet[i].CX,
                                    ACL72_Pre_Worksheet[i].CY,
                                    ACL72_Pre_Worksheet[i].CZ,
                                    ACL72_Pre_Worksheet[i].DA,
                                    ACL72_Pre_Worksheet[i].DB,
                                    ACL72_Pre_Worksheet[i].DC,
                                    ACL72_Pre_Worksheet[i].DD,
                                    ACL72_Pre_Worksheet[i].DE,
                                    ACL72_Pre_Worksheet[i].DF,
                                    ACL72_Pre_Worksheet[i].DG,
                                    ACL72_Pre_Worksheet[i].DH,
                                    ACL72_Pre_Worksheet[i].DI,
                                    ACL72_Pre_Worksheet[i].DJ,
                                    ACL72_Pre_Worksheet[i].DK,
                                    ACL72_Pre_Worksheet[i].DL,
                                    ACL72_Pre_Worksheet[i].DM,
                                    new Date((ACL72_Pre_Worksheet[i].DN, - (25567 + 1))*86400*1000), // im doing this because excel serialized the date
                                    ACL72_Pre_Worksheet[i].DO,
                                    ACL72_Pre_Worksheet[i].DP,
                                ]
                            )
                        }
                    }
